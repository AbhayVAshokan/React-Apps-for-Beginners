...
const Calculator: React.FunctionComponent<{}> = () => {
    ...
    let [clearMode, setClearMode] = useState<boolean>(false);
    let [finalResult, setFinalResult] = useState<string>("0");
    ...
    const onDigitClick: (num: string) => void = (num) => {
    ...
    const onOperatorClick: (op: string) => void = (op) => {
